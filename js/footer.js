document.addEventListener("DOMContentLoaded",()=>{
    ...
    const explode = ()=>{
        ...
        createParticles();
        const particleElement =document.querySelectorAll(".explosion-particle-img");
        const particles = Array.from(particleElement).map(
        ...
        const animate = ()=>{
            ...
            if(
                particles.every(
                    (particles) => particle.y > explosionContainer.offsetHeight /2
                )
            ) {
